...
@Component(service = Servlet.class,
		...
		property = { Constants.SERVICE_DESCRIPTION + "=page title Demo Servlet",
				...
				"sling.servlet.resourceTypes=" + "hyundaidemo/components/page",
				"sling.servlet.extensions=" + "txt" })
public class UsingServletPagenameDemo extends SlingSafeMethodsServlet {

	private static final Logger LOG = LoggerFactory.getLogger(UsingServletPagenameDemo.class);
	...
	protected void doGet(final SlingHttpServletRequest req, final SlingHttpServletResponse resp)
		...
		LOG.debug("\n===============Executing==========================");
		resp.getWriter().write("Page Name =" + resource.getValueMap().get(JcrConstants.JCR_TITLE));
